...
function SkeletonRow() {
  return (
    <div className="grid animate-pulse grid-cols-26 gap-4 border-t border-slate-100 px-5 py-4">
      <div className="col-span-9 h-4 rounded bg-slate-200" />
          ...
          {rows.length === 0 && !tableLoading ? (
            ...
            <>
              <section className="overflow-hidden rounded-3xl border border-slate-200 bg-white">
                <div className="grid grid-cols-26 gap-4 border-b border-slate-200 bg-slate-50 px-5 py-4 font-bold text-slate-800">
                  ...
                  <div className="col-span-3 text-center">Сэтгэгдэл</div>
                  <div className="col-span-3 text-center">Шинэчилсэн</div>
                ...
                {tableLoading ? (
                  ...
                  rows.map((item) => {
                    ...
                    return (
                      <div
                        key={item.id}
                        className="grid grid-cols-26 gap-4 border-t border-slate-100 px-5 py-4 transition hover:bg-slate-50"
                      >
                        <Link
                          href={`/test/${item.id}`}
                          className="col-span-9 min-w-0 pr-5 flex items-center"
                        >
                        ...
                        <div className="col-span-4 pr-3 flex flex-col justify-center text-slate-800">
                        ...
                        <div className="col-span-2 flex items-center justify-center text-slate-800">
                          ...
                          <div className="flex flex-col items-center">
                            <div className="flex items-center gap-3">
                              <span className="text-main flex items-center gap-1">
                                <SmileCircleBoldDuotone width={16} />
                        ...
                        <div className="col-span-1 flex items-center justify-center ">
                          <DropdownMenu>
                            <DropdownMenuTrigger asChild>
                              <Button variant="ghost" className="w-9.5">
                                <MoreIcon />
                              </Button>
                            </DropdownMenuTrigger>
